  ...
  if (row.type === 'virt' && /(брест|brest|виртуализ)/i.test(haystack)) {
    return buildGroupedSpecs([
      ...
      },
      {
        ...
        rows: [
          { name: 'Регулярное обновление для нейтрализации угроз эксплуатации уязвимостей', value: 'Наличие' },
          { name: 'Функционирование в среде операционной системы из Единого реестра российского ПО', value: 'Наличие' },
          { name: 'Эмуляция аппаратного обеспечения с использованием KVM', value: 'Наличие' },
          { name: 'Создание виртуальных машин, образов и шаблонов с поддержкой 32 и 64-битных гостевых ОС', value: 'Наличие' },
          { name: 'Создание ВМ из настраиваемых шаблонов', value: 'Наличие' },
          { name: 'Поддержка в ВМ до 256 виртуальных процессоров', value: 'Наличие' },
          { name: 'Поддержка в ВМ до 2000 ГБ оперативной памяти', value: 'Наличие' },
          { name: 'Идентификация и аутентификация субъектов доступа', value: 'Наличие' },
          { name: 'Функционирование в условиях мандатного и дискреционного разграничения доступа', value: 'Наличие' },
          { name: 'Запуск ВМ в виде отдельного процесса', value: 'Наличие' },
          { name: 'Совместимость и интеграция с доменом FreeIPA и службой каталога для Linux', value: 'Наличие' },
          { name: 'Интерфейс на русском языке', value: 'Наличие' },
          { name: 'Совместимость с программным обеспечением для управления виртуальными рабочими местами (VDI)', value: 'Наличие' },
          { name: 'Поддержка различных сценариев виртуализации рабочих мест', value: 'Наличие' },
          { name: 'Управление конфигурацией ВМ', value: 'Наличие' },
          { name: 'Изменение количества выделенных процессоров и размера ОЗУ без завершения функционирования ВМ', value: 'Наличие' },
          { name: 'Подключение к ВМ устройств из состава аппаратных средств', value: 'Наличие' },
          { name: 'Добавление виртуальных дисков без остановки ВМ', value: 'Наличие' },
          { name: 'Клонирование ВМ', value: 'Наличие' },
          { name: 'Сохранение ВМ как шаблона', value: 'Наличие' },
          { name: 'Создание кластеров высокой доступности', value: 'Наличие' },
          { name: 'Выполнение миграции работающих ВМ между узлами кластера', value: 'Наличие' },
          { name: 'Ручная балансировка нагрузки', value: 'Наличие' },
          { name: 'Автоматическое распределение ресурсов между работающими ВМ', value: 'Наличие' },
          { name: 'Защита файлов-образов ВМ от модификации', value: 'Наличие' },
          { name: 'Централизованное управление кластерами, хранилищами и виртуальными коммутаторами', value: 'Наличие' },
          { name: 'Мониторинг работоспособности и использования ресурсов ВМ', value: 'Наличие' },
          { name: 'Поддержка VLAN/VXLAN', value: 'Наличие' },
          { name: 'Регистрация событий', value: 'Наличие' },
          { name: 'Централизованное хранение конфигурационной информации', value: 'Наличие' },
          { name: 'Подключение к ВМ по протоколу SPICE', value: 'Наличие' },
          { name: 'Встроенная консоль в веб-интерфейсе', value: 'Наличие' },
          { name: 'Перенос ВМ между узлами кластера без прерывания сетевого трафика', value: 'Наличие' },
          { name: 'Миграция дисков работающих ВМ между хранилищами', value: 'Наличие' },
          { name: 'Ограничение сетевого и дискового ввода-вывода ВМ', value: 'Наличие' },
          { name: 'Поддержка протокола IPMI 2.0', value: 'Наличие' },
          { name: 'Поддержка расширения количества управляемых ВМ до 10 000', value: 'Наличие' },
          { name: 'Поддержка кластером управления до 1250 серверов виртуализации', value: 'Наличие' },
          { name: 'Поддержка сервером виртуализации до 32 процессоров', value: 'Наличие' },
          { name: 'Поддержка сервером виртуализации до 384 физических ядер', value: 'Наличие' },
          { name: 'Поддержка сервером виртуализации до 6 ТБ оперативной памяти', value: 'Наличие' },
          { name: 'Групповое создание 500 и более ВМ из шаблонов', value: 'Наличие' },
          { name: 'Поддержка механизмов оптимизации оперативной памяти', value: 'Наличие' },
          { name: 'Автоматический ввод ВМ в домен', value: 'Наличие' },
          { name: 'Наличие клиентского приложения с графическим интерфейсом', value: 'Наличие' },
          { name: 'Работа с хранилищем LVM', value: 'Наличие' },
          { name: 'Создание и использование распределённого блочного хранилища Ceph', value: 'Наличие' },
          { name: 'Наличие сервисного режима обслуживания узла', value: 'Наличие' },
          { name: 'Возможность создания доменных пользователей', value: 'Наличие' },
          { name: 'Встроенное резервное копирование для ВМ', value: 'Наличие' },
          { name: 'Расширение диска ВМ он-лайн', value: 'Наличие' },
          { name: 'Поддержка виртуальной машиной до 52 виртуальных дисков', value: 'Наличие' },
          { name: 'Поддержка виртуальной машиной до 26 сетевых интерфейсов', value: 'Наличие' },
          { name: 'Расширение хранилищ он-лайн', value: 'Наличие' },
          { name: 'Наличие провайдера для Terraform', value: 'Наличие' },
          { name: 'Развертывание продукта с использованием подхода IaaC', value: 'Наличие' },
          { name: 'Создание изолированных тенантов', value: 'Наличие' },
          { name: 'Развертывание географически распределенной инфраструктуры', value: 'Наличие' },
          { name: 'Интеграция с Microsoft AD DS через доверительные отношения', value: 'Наличие' },
          { name: 'Поддержка технологии единого входа - SSO Kerberos', value: 'Наличие' },
          { name: 'Поддержка Affinity / Anti-Affinity правил', value: 'Наличие' },
          { name: 'Поддержка групп ВМ с общим жизненным циклом', value: 'Наличие' },
          { name: 'Инициализация ВМ', value: 'Наличие' },
          { name: 'Квоты на использование ресурсов', value: 'Наличие' },
          { name: 'Тарификация использования ресурсов', value: 'Наличие' },
          { name: 'Создание виртуальных дата центров', value: 'Наличие' },
          { name: 'Реализация модели доступа на базе ACL', value: 'Наличие' },
          { name: 'Фильтрация трафика для виртуальных сетей', value: 'Наличие' },
          { name: 'Визуализация топологии сети', value: 'Наличие' },
          { name: 'Создание виртуальных сетей из шаблонов', value: 'Наличие' },
          { name: 'Централизованный источник шаблонов ВМ', value: 'Наличие' },
          { name: 'Загрузка образов дисков с HTTP-ресурсов', value: 'Наличие' },
          { name: 'Горячее подключение сетевых интерфейсов и дисков к ВМ', value: 'Наличие' },
          { name: 'Снимки состояния ВМ и дисков', value: 'Наличие' },
          { name: 'Наличие DRS', value: 'Наличие' },
          { name: 'Панель в веб-интерфейсе с основной информацией о платформе', value: 'Наличие' },
        ],
      },
      {
        title: '3. Безопасность, совместимость и эксплуатация',
        rows: [
          { name: 'Интеграция со службой каталогов', value: 'Наличие' },
          { name: 'Совместимость с Termidesk', value: 'Наличие' },
          { name: 'Совместимость с RuBackup', value: 'Наличие' },
          { name: 'Ролевая модель доступа (RBAC)', value: 'Наличие' },
          { name: 'Журналирование событий и аудит действий', value: 'Наличие' },
          { name: 'Мандатное управление доступом к виртуальным машинам', value: 'Наличие' },
          { name: 'Шифрование трафика управления', value: 'TLS 1.2 и выше' },
          { name: 'Централизованная консоль управления', value: 'Наличие' },
          { name: 'Мониторинг ресурсов кластера', value: 'Наличие' },
          { name: 'Отказоустойчивая схема развёртывания', value: 'Поддержка' },
        ],
      },
      {
...
async function buildDocx(rows: GoodsRow[], lawMode: LawMode): Promise<Blob> {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    for (let i = 0; i < doneRows.length; i++) {
      ...
      children.push(new Paragraph({ children: [], spacing: { after: 40 } }));
      children.push(centerPara(isSW ? 'Требования к техническим характеристикам программного обеспечения' : 'Требования к техническим характеристикам поставляемого товара', { size: FONT_SIZE }));
  ...
  const renderPreview = () => {
    ...
    return (
      <div className="tz-preview" style={{ marginTop: 24, fontSize: 12, fontFamily: 'Times New Roman, serif', lineHeight: 1.5, color: '#F5F0E8' }}>
        ...
        {/* === ПРИЛОЖЕНИЯ (по одному на каждую позицию) === */}
        {done.map((row, idx) => {
          const g = lookupCatalog(row.type);
          const isSW = !!g.isSoftware;
          const nacRegime = row.meta?.nac_regime || getUnifiedNacRegime(row.type);
