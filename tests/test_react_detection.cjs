...
const testCases = [
  ...
  { input: 'флеш', expected: 'flashDrive', mode: 'exact' },
  { input: 'флэшка 64 гб', expected: 'flashDrive', mode: 'exact' },
  { input: 'ноут', expected: 'laptop', mode: 'exact' },
  { input: 'системник', expected: 'pc', mode: 'exact' },
  { input: 'оперативка ddr5 32gb', expected: 'ram', mode: 'exact' },
