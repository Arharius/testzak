...
export const GOODS_CATALOG: Record<string, GoodsItem> = {
  ...
  dvd: {
    ...
    hardTemplate: [
      { group: 'Тип носителя', name: 'Тип оптического носителя', value: 'DVD-R однократной записи или DVD+R / DVD-RW / CD-R / BD-R — указать конкретный тип в наименовании позиции' },
  ...
  patchCord: {
    ...
    hardTemplate: [
      { group: 'Характеристики', name: 'Тип кабеля', value: 'UTP (неэкранированный) или F/UTP (фольгированный экранированный)' },
  ...
  hdmiCable: {
    ...
    hardTemplate: [
      { group: 'Характеристики', name: 'Тип интерфейса', value: 'HDMI или DisplayPort' },
      ...
      { group: 'Характеристики', name: 'Разъёмы', value: 'HDMI тип A — HDMI тип A (оба конца)' },
      { group: 'Состояние', name: 'Состояние', value: 'Новый, в оригинальной упаковке, без повреждений кабеля и разъёмов' },
    ],
  },
  powerCable: {
    ...
    hardTemplate: [
      { group: 'Характеристики', name: 'Тип', value: 'Кабель питания или сетевой удлинитель — указать конкретный тип в наименовании позиции' },
      { group: 'Характеристики', name: 'Разъём подключения к сети', value: 'Вилка евростандарт CEE 7/16 (Schuko) или IEC C13' },
  ...
  battery: {
    ...
    hardTemplate: [
      { group: 'Тип элемента', name: 'Типоразмер', value: 'AA (LR6) или AAA (LR03) — указать конкретный типоразмер в наименовании позиции' },
  ...
  batteryLithium: {
    ...
    hardTemplate: [
      { group: 'Тип элемента', name: 'Типоразмер', value: 'CR2032' },
  ...
  cableTester: {
    name: 'Тестер кабеля / LAN / телефонный тестер',
    okpd2: '26.51.43.000',
    okpd2name: 'Приборы и аппаратура для измерения электрических величин',
    ktruFixed: '26.51.43.000-00000001',
    placeholder: 'Например: Тестер витой пары RJ45, телефонный тестер с генератором, PoE-тестер...',
  },
  soldering: {
  ...
  usbToken: {
    ...
    placeholder: 'Например: Рутокен Lite 1010, Рутокен ЭЦП 3.0, JaCarta ГОСТ...',
    hardTemplate: [
      { group: 'Общие характеристики', name: 'Тип устройства', value: 'USB-токен (ключевой носитель информации) или эквивалент' },
      { group: 'Общие характеристики', name: 'Назначение', value: 'Безопасное хранение ключей электронной подписи, аутентификация пользователей, хранение цифровых сертификатов' },
      { group: 'Общие характеристики', name: 'Интерфейс подключения', value: 'USB Type-A (полноразмерный)' },
      { group: 'Общие характеристики', name: 'Совместимость с USB', value: 'USB 2.0 Full Speed и выше (с обратной совместимостью USB 1.1)' },
      { group: 'Криптографические характеристики', name: 'Поддерживаемые криптоалгоритмы', value: 'ГОСТ Р 34.10-2012 (256/512 бит), ГОСТ Р 34.11-2012, ГОСТ 28147-89 или эквивалентные' },
      { group: 'Криптографические характеристики', name: 'Объём защищённой памяти (EEPROM)', value: 'не менее 64', unit: 'КБ' },
      { group: 'Криптографические характеристики', name: 'Количество хранимых ключевых контейнеров', value: 'не менее 10', unit: 'шт.' },
      { group: 'Криптографические характеристики', name: 'Двухфакторная аутентификация (PIN-код)', value: 'Да' },
      { group: 'Сертификация и совместимость', name: 'Наличие в Едином реестре российских программ Минцифры', value: 'Да (номер реестровой записи указывается в составе заявки)' },
      { group: 'Сертификация и совместимость', name: 'Совместимость с СКЗИ', value: 'КриптоПро CSP, VipNet CSP, Signal-COM CSP или эквивалентные' },
      { group: 'Сертификация и совместимость', name: 'Совместимость с ОС', value: 'Astra Linux, Alt Linux, Windows 10/11, macOS или эквивалентные' },
      { group: 'Сертификация и совместимость', name: 'Поддержка стандартов', value: 'PKCS#11, Microsoft CryptoAPI, PC/SC' },
      { group: 'Эксплуатационные характеристики', name: 'Срок хранения данных в памяти', value: 'не менее 10', unit: 'лет' },
      { group: 'Эксплуатационные характеристики', name: 'Количество циклов записи в память', value: 'не менее 500 000', unit: 'циклов' },
      { group: 'Эксплуатационные характеристики', name: 'Рабочая температура', value: 'от 0 до +50', unit: '°С' },
      { group: 'Эксплуатационные характеристики', name: 'Индикатор работы', value: 'Светодиодный индикатор активности' },
      { group: 'Эксплуатационные характеристики', name: 'Материал корпуса', value: 'Пластик' },
      { group: 'Состояние', name: 'Состояние', value: 'Новый, в оригинальной упаковке производителя' },
    ],
  },
  keyboardMouseSet: {
...
const TYPE_HINTS: Array<{ tokens: string[]; type: string }> = [
  ...
  // ── Флешки ──
  { tokens: ['флеш-накопитель','флеш накопитель','флешка','флэшка','флеш','flash drive','usb flash','usb накопитель','usb-накопитель','usb флеш','юсб флеш','transcend jetflash','sandisk cruzer','внешний накопитель на флеш','носитель на флеш','флэш-накопитель','флэш накопитель','носитель информации на флеш','накопитель на флеш','внешний накопитель'], type: 'flashDrive' },
  ...
  { tokens: ['тестер кабеля','тестер кабельный','кабельный тестер','lan-тестер','lan тестер','cable tester','poe тестер','тестер телефонного кабеля','телефонный тестер','тон генератор','тон-генератор','генератор тона','генератор с щупом','индуктивный щуп'], type: 'cableTester' },
