...
const specHintsMap: Record<string, string> = {
    ...
    ldap: [
      ...
      '- Миграция из Microsoft Active Directory',
      '--- ГРУППА: Безопасность ---',
    ...
    osSupport: [
      ...
      '- Уровень техподдержки (Стандартная / Расширенная / Привилегированная)',
...
` : '';
  ...
  const minSpecs = (isLicenseContext || isSupportContext) ? 30 : (isSW ? 25 : 20);
...
${hint}
${licenseContextHint}${supportContextHint}
ВАЖНО:
