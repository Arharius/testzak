      ...
      <div className="workspace-side-card workspace-composer-card">
        ...
        <div className="workspace-action-grid workspace-action-grid--toolbar">
          ...
          <button
            ...
            title={!docxReady ? 'Сначала подготовьте характеристики' : paymentRequired ? 'Trial завершён' : 'Экспертная проверка на соответствие 44-ФЗ/223-ФЗ, ФАС-риски и логические ошибки'}
            className="workspace-review-btn"
          >
            {docxReady ? '🔍 Проверить ТЗ на ФАС-риски' : '🔍 Проверка ТЗ'}
          </button>
        </div>
        {splitFeatureVisible && (
